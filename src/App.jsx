  ...
  return (
    <>
      ...
      <div id="page" className="s-pagewrap">
              ...
              <div className="s-header__block">
                <div className="s-header__logo">
                  <a className="logo" href="index.html">
                    <img alt="Homepage" src="images/logo.svg" />
                  </a>
                </div>
              ...
              <div className="column lg-12 s-intro__content-inner grid-block grid-16">
                <div className="s-intro__content-text">
                  ...
                  <h1 className="s-intro__content-title">
                    I'm Jonathan Doe <br />a product designer <br />
                    base in Somewhere.
                  </h1>
            ...
            <div className="row s-about__content">
              <div className="column xl-12">
                ...
                <p className="attention-getter">
                  ...
                  explicabo id debitis cupiditate cumque, error quia! Debitis cupiditate
                  ipsa nihil labore, earum atque dolor quos saepe vero inventore, odit
                  nam deleniti accusantium omnis mollitia consequatur harum incidunt! Ex
                  modi aut repudiandae doloremque commodi recusandae labore sit.
                  Perspiciatis omnis dolor dolores fuga iusto, recusandae animi nisi
                  consequuntur exercitationem id maxime earum pariatur voluptas! Porro
                  non quos quae tempora fuga quis sequi minus sed sint debitis
              ...
              <div className="column entry">
                ...
                <div className="glightbox-desc entry__desc-01">
                  <p>
                    ...
                    ipsum iste soluta fugiat, impedit illum ducimus deleniti facilis ab,
                    tempora non! Nisi, tempora provident.
          ...
          <section className="s-numbers" id="numbers">
            <div className="row counter-items">
              ...
              <div className="column counter-items__item">
                ...
                <p>
                  ...
                  Fusce vel dui. In ac felis quis tortor malesuada pretium
                </p>
              </div>
              <div className="column counter-items__item">
                <div className="num">
                ...
                <p>
                  ...
                  Voluptatem dignissimos ut ducimus
                </p>
              </div>
              <div className="column counter-items__item">
                <div className="num">
          ...
          <footer className="s-footer target-section" id="footer">
            ...
            <div className="row s-footer__content">
              <div className="column xl-6 md-12 s-footer__block s-footer__about">
                <p className="attention-getter">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas
                  illum quasi facere libero, fugiat laboriosam possimus amet consectetur
                  adipisicing elit reprehenderit eveniet tempore quisquam ipsa id esse.
                  Facere ratione dignissimos.
                </p>
              </div>
            ...
            <div className="row s-footer__buttons">
              <div className="column xl-6 tab-12">
                <a className="btn btn--primary btn--large u-fullwidth" href="mailto:#0">
                  Message Me
                </a>
              </div>
              <div className="column xl-6 tab-12">
